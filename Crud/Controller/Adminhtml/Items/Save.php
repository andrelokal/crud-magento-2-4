...
class Save extends \Andre\Crud\Controller\Adminhtml\Items
{
            ...
            try {
                ...
                if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != '') {
                    try{
                        ...
                        $destinationPath = $mediaDirectory->getAbsolutePath('andre/crud');
                        ...
                        $imagePath = 'andre/crud'.$result['file'];
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('andre_crud/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('andre_crud/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('andre_crud/*/new');
                }
                return;
            } catch (\Exception $e) {
                ...
                $this->_redirect('andre_crud/*/edit', ['id' => $this->getRequest()->getParam('id')]);
                return;
            }
        }
        $this->_redirect('andre_crud/*/');
